...
namespace ModulB.ViewModels
{
    class ModulBViewModel
    {
        OpenCommand open;
        ...
        public void ShowModuleWindow()
        {
            ...
            if (regionManager.Regions["Workspace"] != null)
            {
                ...
                regionManager.RegisterViewWithRegion("Workspace", typeof(ModulB.Views.ModulBView));
            }
        }
    }
}
